                ...
                <div class="modal-body" id="">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-lg-3 col-md-4 control-label" for="">Tickets Number</label>
                            <div class="col-lg-9 col-md-8">
                                <input type="text" class="form-control" name="bus_number"  value="" placeholder="Tickets Number">
                            </div>
                        </div>
                        {{--</div>--}}
                        <!-- End .form-group  -->
